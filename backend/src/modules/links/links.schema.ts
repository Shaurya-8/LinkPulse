...
export const createLink = z.object({
    body: z.object({
        ...
        clickLimit: z.number().int().min(1).max(1000000).optional(),
...
export type CreateLinkInput = z.infer<typeof createLink>['body'];
export type UpdateLinkInput = z.infer<typeof updateLink>['body'];
export type GetLinksQuery = z.infer<typeof getLinks>['query'];
export type BulkCreateInput = z.infer<typeof bulkCreate>['body'];

export type RedirectLinkIdInput = z.infer<typeof redirectRule>['params'];
export type RedirectRuleInput = z.infer<typeof redirectRule>['body'];
