...
import { generateOtp, hashOtp, verifyOtp, hashPassword, verifyPassword, getOtpExpiry, generateSecureToken, hashToken, } from './crypto.js';
describe('crypto.ts utilities', () => {
    ...
    describe('hashToken', () => {
        it('should correctly hash a token using sha256', () => {
            ...
            expect(hashed).toBe('a6c6e7a2b978a1be5b376c6c73df64ec26194b1a4574971c261e479c3d4a4d33' // SHA-256 of 'mySecureToken'
            );
        });
    });
});
