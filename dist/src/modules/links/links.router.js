...
router.post('/create', optionalAuthenticate, validate({ body: createLink.shape.body }), linksController.create);
router.get('/', authenticate, validate({ query: getLinks.shape.query }), linksController.getAll);
